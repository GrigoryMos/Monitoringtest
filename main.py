                ...
                BoxLayout:
                    ...
                    MDTabs:
                        ...
                        Tab:
                            id: tab1
                            name: 'tab1'
                            text: f"[size=20][font={fonts[-1]['fn_regular']}]{md_icons['calculator-variant']}[/size][/font] Оценки"
                            ...
                            BoxLayout:
                                ...
                                BoxLayout:
                                    ...
                                    MDTextField:
                                        id: needs
                                        hint_text: "Необходимая оценка/баллы"
                                ...
                                BoxLayout:
                                    ...
                                    MDTextField:
                                        id: months
                                        hint_text: "Остаток времени (в месяцах)"
                        ...
                        Tab:
                            id: tab5
                            name: 'tab5'
                            text: f"[size=20][font={fonts[-1]['fn_regular']}]{md_icons['book-open-variant']}[/size][/font] История"
...
class MonitoringApp(MDApp):
    ...
    def __init__(self, **kwargs):
        ...
        menu_items = [{"icon": "format-text-rotation-angle-up", "text": "По возрастанию"}, {"icon": "format-text-rotation-angle-down", "text": "По убыванию"}]
    ...
    def on_start(self):
        ...
        self.screen.ids.rereceive_type.text = "По возрастанию"

        icons_item_menu_lines = {
            "order-numeric-ascending": "Оценки",
            "human-queue": "Группа",
            "head-plus-outline": "Преподаватели",
            "format-list-text": "Расписание",
            "share-variant": "Поделиться",  #air-horn
            "shield-sun": "Dark/Light",
        }
        icons_item_menu_tabs = {
            "calculator-variant": "Оценки",  #ab-testing
            "table-large": "Таблица",
            "chart-areaspline": "График",
            "chart-pie": "Диаграмма",  # chart-arc
            "book-open-variant": "История",
        }
